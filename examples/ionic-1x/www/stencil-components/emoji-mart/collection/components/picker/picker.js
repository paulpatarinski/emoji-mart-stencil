...
export class Picker {
        ...
        if (this.custom.length > 0) {
            CUSTOM_CATEGORY.emojis = this.custom.map(emoji => {
                return Object.assign({}, emoji, { 
                    ...
                    id: emoji.short_names[0], custom: true });
            });
    ...
    static get properties() { return { "_forceUpdate": { "state": true }, "_loadedCategories": { "state": true }, "autoFocus": { "type": Boolean, "attr": "auto-focus" }, "backgroundImageFn": { "type": "Any", "attr": "background-image-fn" }, "clearSearch": { "method": true }, "color": { "type": String, "attr": "color" }, "custom": { "type": "Any", "attr": "custom" }, "emoji": { "type": String, "attr": "emoji" }, "EMOJI_DATASOURCE_VERSION": { "state": true }, "emojiSize": { "type": Number, "attr": "emoji-size" }, "emojisToShowFilter": { "type": "Any", "attr": "emojis-to-show-filter" }, "emojiTooltip": { "type": "Any", "attr": "emoji-tooltip" }, "exclude": { "type": "Any", "attr": "exclude" }, "host": { "elementRef": true }, "i18n": { "type": "Any", "attr": "i18n" }, "include": { "type": "Any", "attr": "include" }, "native": { "type": "Any", "attr": "native" }, "onEmojiClicked": { "type": "Any", "attr": "on-emoji-clicked" }, "perLine": { "type": Number, "attr": "per-line" }, "pickerStyle": { "type": "Any", "attr": "picker-style" }, "recent": { "type": "Any", "attr": "recent" }, "resetScroll": { "method": true }, "set": { "type": String, "attr": "set" }, "sheetSize": { "type": "Any", "attr": "sheet-size" }, "showAnchors": { "type": Boolean, "attr": "show-anchors" }, "showPreview": { "type": Boolean, "attr": "show-preview" }, "skin": { "type": "Any", "attr": "skin" }, "title": { "type": String, "attr": "title" }, "width": { "type": String, "attr": "width" } }; }
}
